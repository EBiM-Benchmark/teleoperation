...
#
# Run this in a REAL terminal. Without a TTY, keyboard_state_publisher dies on termios and
# the `m` DRIVE/RECORD toggle is unavailable - the pedals still drive the base, but you
# cannot switch them to LABS recording duty.
